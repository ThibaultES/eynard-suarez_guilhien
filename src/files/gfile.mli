...
val from_file: path -> (int) graph * id list * id list
...
(* Fonction créant un fichier .svg pour un string graph *)
...
(* *)
val from_file_with_cost: path -> (int*int) graph * id list * id list