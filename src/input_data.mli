...
Entrées : Un graphe G = (S,A) représenté par une liste S de sommets et A d'arcs.
          Un arc de i à j est représenté par un tuple (i, j, c) où c est la capacité maximale de l'arc.
...
Entrées : Un graphe G = (S,A) représenté par une liste S de sommets et A d'arcs.
          Un arc de i à j est représenté par un tuple (i, j, c, w) où c est la capacité maximale de l'arc
          et w est le coût par unité de flux de l'arc.
